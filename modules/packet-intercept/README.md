...
| organization_id | The organization resource is the root node in GCP resource hierarchy and is the hierarchical super node of projects. [For more detailes](https://cloud.google.com/resource-manager/docs/creating-managing-organization)| string  | N/A | "" | yes
