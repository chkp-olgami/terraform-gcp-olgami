...
| sic_key| The Secure Internal Communication one time secret used to set up trust between the gatewayes objects and the management server                                                                                                                            | string | At least 12 alpha numeric characters | "" | yes
...
| ---------------- | ------------- |
| 20250104 | Added Packet Intercept template
